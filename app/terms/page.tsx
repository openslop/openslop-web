...
export default function TermsOfService() {
  return (
    <StaticPageLayout
      ...
      subtitle="Last updated: February 15, 2026"
    >
      <div>
        ...
        <p className="mt-2 leading-relaxed">
          By accessing or using OpenSlop (&quot;the Service&quot;), you agree to
      ...
      <div>
        ...
        <p className="mt-2 leading-relaxed">
          OpenSlop provides an AI-powered media generation platform. We reserve
      ...
      <div>
        ...
        <ul className="mt-2 list-disc space-y-1 pl-6">
          ...
          <li>
            Transfer your account or access rights to another party without our
            consent
          </li>
        </ul>
      </div>
      ...
      <div>
        ...
        <p className="mt-2 leading-relaxed">
          ...
          the Service, you grant us a non-exclusive license to process your
          inputs solely for the purpose of delivering the Service to you.
        </p>
      </div>
      ...
      <div>
        ...
        <p className="mt-2 leading-relaxed">
          To the fullest extent permitted by law, OpenSlop and its affiliates
